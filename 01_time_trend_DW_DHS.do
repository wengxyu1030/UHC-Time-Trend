...
***************************
//ssc install fs
global DATA "${SOURCE}/DHS-Nov2021" 
cd "${DATA}"
fs  *.dta
...
use "${DATA}/`survey'",clear
	...
	***for variables generated from 9_child_anthropometrics
	foreach var of var c_underweight c_stunted	c_wfa  c_hfa  c_wfh  c_stuund {
...
save "${INTER}/Indicator_`survey'_DHS", replace  
